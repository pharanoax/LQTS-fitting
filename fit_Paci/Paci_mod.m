...
function [VOI, STATES, ALGEBRAIC, CONSTANTS] = Paci_mod(scaling_factors, iKr_parameters, iKs_parameters)
...
%   12  G_bCa    bCa maximal conductance             CONSTANTS(:,40)
   ...
   [VOI, STATES, ALGEBRAIC, CONSTANTS] = solveModel(scaling_factors, iKr_parameters, iKs_parameters);
end
...
function [VOI, STATES, ALGEBRAIC, CONSTANTS] = solveModel(scaling_factors, iKr_parameters, iKs_parameters)
