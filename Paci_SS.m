...
function [VOI, STATES, ALGEBRAIC, CONSTANTS] = Paci_SS(time)
    % This is the "main function".  In Matlab, things work best if you rename this function to match the filename.
   [VOI, STATES, ALGEBRAIC, CONSTANTS] = solveModel(time);
end
...
function [VOI, STATES, ALGEBRAIC, CONSTANTS] = solveModel(time)
