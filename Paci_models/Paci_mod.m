...
function [VOI, STATES, ALGEBRAIC, CONSTANTS] = Paci_mod(scaling_factors)
...
function [STATES, CONSTANTS] = initConsts(scaling_factors)
    ...
    CONSTANTS(:,31) = 0.002;
    CONSTANTS(:,32) = scaling_factors(3)*29.8667;
    STATES(:,11) = 0.00778547011240132;
    STATES(:,12) = 0.432162576531617;
    CONSTANTS(:,33) = 0.025;
    CONSTANTS(:,34) = 2.3;
    CONSTANTS(:,35) = scaling_factors(4)*2.041;
    STATES(:,13) = 0.0322944866983666;
    CONSTANTS(:,36) = scaling_factors(5)*28.1492;
    CONSTANTS(:,37) = scaling_factors(6)*30.10312;
    CONSTANTS(:,38) = -0.017;
    ...
    CONSTANTS(:,41) = 1;
    CONSTANTS(:,42) = 40;
    CONSTANTS(:,43) = scaling_factors(7)*1.841424;
    CONSTANTS(:,44) = scaling_factors(8)*4900;
