function [SS_VOI, SS_STATES] = SteadyState( t1, ScalingFactors, iKr_parameters, iKs_parameters )
...
%     assert(SStime < 400,'The data does not reach steady state')
    ...
    [SS_VOI, SS_STATES, ~, ~] = Paci_modSS(SStime, ScalingFactors,iKr_parameters, iKs_parameters);
