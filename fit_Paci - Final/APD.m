function APD50 = APD(V,t,b_V,p_V,p_i)
...
% Calculating the voltage that achieves APD50
Amplitude = p_V-b_V;
limit = b_V+0.5*Amplitude;

% Interpolating to find the start and end of the APD50
y1 = (V(1:p_i));
x1 = t(1:p_i);
[y1, index1] = unique(y1);
...
% Calculating the APD50
APD50 = AP_end - AP_start;

% Plotting the start and end of the APD50
%     hold on
