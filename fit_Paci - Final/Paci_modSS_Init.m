...
function [VOI, STATES, ALGEBRAIC, CONSTANTS] = Paci_modSS_Init(time, scaling_factors, iKr_parameters, iKs_parameters, initSTATES)
...
%   12  G_bCa    bCa maximal conductance             CONSTANTS(:,40)
   ...
   [VOI, STATES, ALGEBRAIC, CONSTANTS] = solveModel(time, scaling_factors, iKr_parameters, iKs_parameters, initSTATES);
end
...
function [VOI, STATES, ALGEBRAIC, CONSTANTS] = solveModel(time, scaling_factors, iKr_parameters, iKs_parameters, initSTATES)
    % Create ALGEBRAIC of correct size
    global algebraicVariableCount;  algebraicVariableCount = getAlgebraicVariableCount();
    % Initialise constants and state variables
    [INIT_STATES, CONSTANTS] = initConsts(scaling_factors, iKr_parameters, iKs_parameters);
    [m,~] = size(initSTATES);
    INIT_STATES = initSTATES(m,:);
