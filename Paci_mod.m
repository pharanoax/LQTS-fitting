...
function [RATES, ALGEBRAIC] = computeRates(VOI, STATES, CONSTANTS)
    ...
    ALGEBRAIC(:,46) = 1.7940*( 1.00000.*( ALGEBRAIC(:,23).*ALGEBRAIC(:,37)))./1000.00;
    ...
    ALGEBRAIC(:,47) = 3.0410*( 1.00000.*( ALGEBRAIC(:,24).*ALGEBRAIC(:,38)))./1000.00;
    ...
    ALGEBRAIC(:,48) = 3.4071*( 1.00000.*( ALGEBRAIC(:,25).*ALGEBRAIC(:,39)))./1000.00;
